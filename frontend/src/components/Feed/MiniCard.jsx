...
// Conectar al socket solo si hay URL configurada; evitar fallback a localhost:3001
const socketUrl = process.env.REACT_APP_SOCKET_URL;
const socket = socketUrl ? io(socketUrl, { autoConnect: true }) : null;
...
if (socket) {
  ...
  socket.on("connect_error", (err) => {
    console.warn("Error de conexión Socket.io:", err?.message || err);
  });
}
